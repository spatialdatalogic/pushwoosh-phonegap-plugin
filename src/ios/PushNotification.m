...
PushNotification *gPushNotification;	
...
- (void)onDeviceReady:(CDVInvokedUrlCommand *)command {
	...
	PushNotification *pushHandler = gPushNotification;	//[rootViewController getCommandInstance:@"PushNotification"];
